...
let ParseData = class ParseData {
    constructor(configService) {
        this.configService = configService;
    }
    async passwordHashingBeforeUsage(value) {
        const saltRounds = this.configService.get('bcrypt.round');
...
exports.ParseData = ParseData = __decorate([
